...
import edu.ucdenver.csci3800.fall2018.kilobattleship.ship.*;
...
/**
 * The Board class manages game board creation and output.
 */
public class Board implements Serializable {
  ...
  /**
   * Constructor: Board() creates new game boards for the player and opponent
   */
  Board() {
  ...
  /**
   * Constructor: Board(Board _board) copies an existing Board object.
  ...
  /**
   * setShot(int _x, int _y) allows the user's Client to fire a shot on the opponent
  ...
  /**
   * createBoard() creates and populates a game board with ships
   */
  ...
  /**
   * seedBoard(int shipSize, int shipID) performs the initial placement of a ship in a game board
  ...
  /**
   * printBoard(int x, int y) provides game board output for the Client program
   * @param x x coordinate
   * @param y y coordinate
   */
...
public synchronized List<KiloBattleShip.ship.KiloBattleShip.ship> returnShipList() {
  return ships;
}
